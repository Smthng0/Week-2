...
import dream.factory.learning.chapter11.vice.teaching.collectionsPackage.stackqueueagain.Queue;
import dream.factory.learning.chapter11.vice.teaching.collectionsPackage.stackqueueagain.Stack;
...
public class RemoveRandomPolaTests {
    ...
    public void remove_stack_OK() throws Exception {
        dream.factory.learning.chapter11.vice.teaching.collectionsPackage.stackqueueagain.Stack stack = new Stack(1_000_000);
    ...
    public void remove_queue_OK() throws Exception {
        dream.factory.learning.chapter11.vice.teaching.collectionsPackage.stackqueueagain.Queue queue = new Queue(1_000_000);
        Instant startTime = Instant.now();
